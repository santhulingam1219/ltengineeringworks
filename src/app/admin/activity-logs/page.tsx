  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-sm border border-slate-200 shadow-xs flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 text-xs font-mono text-slate-600 bg-slate-100 px-3 py-1.5 rounded-sm border border-slate-200">
      ...
      {/* Module Filter Bar */}
      <div className="bg-white p-4 rounded-sm border border-slate-200 shadow-xs flex flex-wrap items-center gap-2 text-xs font-mono">
        <span className="text-slate-500 mr-2 flex items-center gap-1 font-bold">
        ...
        {modules.map((m) => (
          <Link
            ...
            className={`px-3 py-1 rounded-xs uppercase font-bold transition-all ${
